...
# Wed Nov 24 15:16:12 COT 2021
# DO NOT MODIFY


# 
# cnn_accelerator_avalon "cnn_accelerator_avalon" v1.0
# José María Jaramillo Hoyos 2021.11.24.15:16:12
...
add_fileset_file SET_CLR.v VERILOG PATH ../rtl/SET_CLR.v
add_fileset_file CONFI_REGS.v VERILOG PATH ../rtl/CONFI_REGS.v
add_fileset_file DEMUX_1_11.v VERILOG PATH ../rtl/DEMUX_1_11.v
...
add_parameter OFFMEM_ADDR_WIDTH INTEGER 32
set_parameter_property OFFMEM_ADDR_WIDTH DEFAULT_VALUE 32
...
add_interface_port avalon_master AVS_m0_adress address Output 18
...
set_interface_property control_signals associatedReset ""
...
add_interface_port control_signals AVS_Counduit_Finished finished Output 1
add_interface_port control_signals AVS_Counduit_Finished_Ok finished_ok Input 1
add_interface_port control_signals AVS_Counduit_Same_W same_w Input 1
add_interface_port control_signals AVS_Counduit_Start start Input 1
