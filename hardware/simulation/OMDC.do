...
add wave -noupdate -label Omdc_Statemachine/State_Register -radix unsigned /OMDC_tb/Omdc/Omdc_Statemachine/State_Register
add wave -noupdate -label Omdc_Statemachine/State_Signal -radix unsigned /OMDC_tb/Omdc/Omdc_Statemachine/State_Signal
...
add wave -noupdate -radix decimal /OMDC_tb/Omdc/Counter_Eqcif/counter
...
add wave -noupdate -radix binary /OMDC_tb/Omdc/Counter_Crow/COUNTER_Clr
add wave -noupdate -radix decimal /OMDC_tb/Omdc/Counter_Crow/counter
add wave -noupdate -radix decimal /OMDC_tb/Omdc/OneDConv0/State_Machine/State_Signal
add wave -noupdate -radix decimal /OMDC_tb/Omdc/OneDConv0/State_Machine/State_Register
