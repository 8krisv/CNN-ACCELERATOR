...
The dataflow architecture of the accelerator is an adaptation of the the BSM (broadcast, stay, migration)  dataflow introduced by Jihyuck Jo et al. Which  is Energy-Efficient because it reduces the number of redundant accesses to the off-chip memory. For more information bout this dataflow check the following paper https://ieeexplore.ieee.org/document/8374840.
